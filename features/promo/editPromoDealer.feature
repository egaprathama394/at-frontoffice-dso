Feature: Edit Promo Outlet Dealer1
    
    Scenario: a admin Outlet Dealer1 try to open form edit promo
        Given login Frontoffice as admin "Outlet Dealer1"
        Given at edit promo form
        Then a admin see all field is filled

    Scenario: a admin Outlet Dealer1 try to edit promo to be blank filed
        Given login Frontoffice as admin "Outlet Dealer1"
        Given at edit promo form
    ...
    Scenario: a admin Outlet Dealer1 try to edit promo with status Active
        Given login Frontoffice as admin "Outlet Dealer1"
        Given at edit promo form
