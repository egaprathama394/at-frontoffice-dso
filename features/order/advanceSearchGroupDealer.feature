Feature: Advance Search Order Group Dealer
...
| All Order |
    ...
    Given login Frontoffice as admin "Group Dealer"
    Given at "<order>" Page
    When admin "Group Dealer" try to see result of advance search "<order>"
    Then admin "Group Dealer" can see result of advance search "<order>"
Examples:
| order |
| Request To Buy |
| Request Test Drive |
